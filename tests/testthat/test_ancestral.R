...
#   dG = igraph::graph.empty(1, directed=T)
#   bG = igraph::graph.empty(1, directed=F)
...
#
#   # Graph with 2 nodes
#   dG = igraph::graph.empty(2, directed=T)
#   bG = igraph::graph.empty(2, directed=F)
#   V(dG)$names = 1:2
#   V(bG)$names = 2:1
...
#
#   ## Two connected nodes
#   dG = igraph::graph.edgelist(t(c(1,2)), directed=T)
#   bG = igraph::graph.empty(2, directed=F)
#   expect_equal(getMaxFlow(getAdjMat(dG), getAdjMat(bG), c(), c(2), numeric(0), 2), 0)
