...
R.oo::setConstructorS3("FlowGraph", function(L = matrix(0, 1, 1), vertexCaps = 1, 
...
#' @export
R.methodsS3::setMethodS3("flowBetween", "FlowGraph", function(this, sources, sinks) {
...
#' @export
R.methodsS3::setMethodS3("updateVertexCapacities", "FlowGraph", function(this, vertices, 
    newCaps) {
...
#' @export
R.methodsS3::setMethodS3("updateEdgeCapacities", "FlowGraph", function(this, edges, 
    newCaps) {
    if (is.vector(edges)) {
